...
public class JoinRoomPasswordFrm extends javax.swing.JFrame {
    ...
    public JoinRoomPasswordFrm(int room, String password) {
        ...
        jButton2.setIcon(new ImageIcon(new ImageIcon("src/assets/door_exit.png").getImage().getScaledInstance(jButton2.getWidth(), jButton2.getHeight(),Image.SCALE_SMOOTH)));
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        RunClient.closeView(RunClient.View.JOINROOMPASSWORD);
